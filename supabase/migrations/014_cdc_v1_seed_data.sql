...
FROM (VALUES
  ('SGBCCICI', 'Société Générale Côte d''Ivoire', 'SGBFCIAB', 'Société Générale'),
  ('BICICICX', 'Banque Internationale pour le Commerce et l''Industrie de la Côte d''Ivoire', 'BICICIAS', 'BNP Paribas'),
  ('NSIACICI', 'NSIA Banque Côte d''Ivoire', 'NSIACIAS', 'Groupe NSIA'),
  ('BOACICIX', 'Bank of Africa Côte d''Ivoire', 'AFRICIAS', 'BOA Group'),
  ('ECABCICI', 'Ecobank Côte d''Ivoire', 'EABORGAS', 'Ecobank Transnational')
