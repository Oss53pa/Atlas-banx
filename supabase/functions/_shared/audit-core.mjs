...
// src/cdc/taxonomy/rubrics.ts
var RUBRICS_TAXONOMY = [
  // ========================================================================
  // 1. COMPTE — Tenue et gestion (26 rubriques)
  // ========================================================================
  { code: "compte", parentCode: null, category: "compte", displayLabelFr: "Compte", unit: "fcfa", isDimensional: false, description: "Cat\xE9gorie racine compte" },
  ...
  { code: "compte.tenue_jeune", parentCode: "compte", category: "compte", displayLabelFr: "Tenue compte jeune/\xE9tudiant", unit: "fcfa", isDimensional: false, description: "Tarif r\xE9duit jeune/\xE9tudiant" },
  ...
  { code: "compte.tenue_pro", parentCode: "compte", category: "compte", displayLabelFr: "Tenue compte professionnel", unit: "fcfa", isDimensional: false, description: "Ind\xE9pendants, professions lib\xE9rales" },
  ...
  { code: "compte.cloture", parentCode: "compte", category: "compte", displayLabelFr: "Frais de cl\xF4ture", unit: "fcfa", isDimensional: false, description: null },
  { code: "compte.fermeture_anticipee", parentCode: "compte", category: "compte", displayLabelFr: "Fermeture anticip\xE9e", unit: "fcfa", isDimensional: false, description: "Avant 12 mois" },
  { code: "compte.inactivite", parentCode: "compte", category: "compte", displayLabelFr: "Frais d'inactivit\xE9", unit: "fcfa", isDimensional: false, description: "Frais appliqu\xE9s sur compte sans mouvement" },
  ...
  { code: "compte.rib", parentCode: "compte", category: "compte", displayLabelFr: "D\xE9livrance RIB", unit: "fcfa", isDimensional: false, description: null },
  ...
  { code: "compte.releve_mensuel", parentCode: "compte", category: "compte", displayLabelFr: "Relev\xE9 de compte mensuel", unit: "fcfa", isDimensional: false, description: null },
  { code: "compte.releve_duplicata", parentCode: "compte", category: "compte", displayLabelFr: "Duplicata de relev\xE9", unit: "fcfa", isDimensional: false, description: null },
  { code: "compte.releve_papier", parentCode: "compte", category: "compte", displayLabelFr: "Relev\xE9 papier (suppl\xE9ment)", unit: "fcfa", isDimensional: false, description: null },
  ...
  // ========================================================================
  { code: "decouverts", parentCode: null, category: "decouverts", displayLabelFr: "D\xE9couverts & Agios", unit: "percent", isDimensional: false, description: "Cat\xE9gorie racine d\xE9couverts" },
  { code: "decouverts.taux_autorise", parentCode: "decouverts", category: "decouverts", displayLabelFr: "Taux d\xE9couvert autoris\xE9 (TEG)", unit: "percent", isDimensional: true, description: "Taux annuel d\xE9couvert dans la limite autoris\xE9e" },
  { code: "decouverts.taux_non_autorise", parentCode: "decouverts", category: "decouverts", displayLabelFr: "Taux d\xE9couvert non autoris\xE9", unit: "percent", isDimensional: false, description: "Taux major\xE9 hors limite autoris\xE9e" },
  ...
  { code: "decouverts.plafond_autorise", parentCode: "decouverts", category: "decouverts", displayLabelFr: "Plafond d\xE9couvert autoris\xE9", unit: "fcfa", isDimensional: true, description: "Montant maximum de d\xE9couvert autoris\xE9" },
  { code: "decouverts.commission_mouvement", parentCode: "decouverts", category: "decouverts", displayLabelFr: "Commission de mouvement", unit: "percent", isDimensional: true, description: "Commission sur mouvements d\xE9biteurs" },
  ...
  { code: "decouverts.cpfd", parentCode: "decouverts", category: "decouverts", displayLabelFr: "Commission du Plus Fort D\xE9couvert", unit: "percent", isDimensional: false, description: "CPFD: % du plus fort solde d\xE9biteur" },
  { code: "decouverts.cpfd_plafond", parentCode: "decouverts", category: "decouverts", displayLabelFr: "Plafond CPFD", unit: "percent", isDimensional: false, description: "Plafond CPFD en % des int\xE9r\xEAts d\xE9biteurs" },
  { code: "decouverts.commission_depassement", parentCode: "decouverts", category: "decouverts", displayLabelFr: "Commission de d\xE9passement", unit: "fcfa", isDimensional: false, description: null },
  { code: "decouverts.penalite_non_autorise", parentCode: "decouverts", category: "decouverts", displayLabelFr: "P\xE9nalit\xE9 d\xE9couvert non autoris\xE9", unit: "fcfa", isDimensional: false, description: null },
  ...
  { code: "decouverts.frais_etude_dossier", parentCode: "decouverts", category: "decouverts", displayLabelFr: "Frais d'\xE9tude dossier d\xE9couvert", unit: "fcfa", isDimensional: true, description: null },
  { code: "decouverts.commission_engagement", parentCode: "decouverts", category: "decouverts", displayLabelFr: "Commission d'engagement", unit: "percent", isDimensional: false, description: "Sur ligne autoris\xE9e non utilis\xE9e" },
  { code: "decouverts.frais_lettre_information", parentCode: "decouverts", category: "decouverts", displayLabelFr: "Lettre d'information pr\xE9alable", unit: "fcfa", isDimensional: false, description: "Lettre pr\xE9alable au pr\xE9l\xE8vement de frais (BCEAO)" },
  { code: "decouverts.frais_renouvellement", parentCode: "decouverts", category: "decouverts", displayLabelFr: "Renouvellement facilit\xE9", unit: "fcfa", isDimensional: false, description: "Renouvellement annuel autorisation" },
  // ========================================================================
  // 3. CARTES BANCAIRES (22 rubriques)
  // ========================================================================
  { code: "cartes", parentCode: null, category: "cartes", displayLabelFr: "Cartes bancaires", unit: "fcfa", isDimensional: false, description: "Cat\xE9gorie racine cartes" },
  { code: "cartes.cotisation_debit", parentCode: "cartes", category: "cartes", displayLabelFr: "Cotisation annuelle carte d\xE9bit", unit: "fcfa", isDimensional: true, description: "Dimension: r\xE9seau (VISA/MC/GIM)" },
  { code: "cartes.cotisation_credit", parentCode: "cartes", category: "cartes", displayLabelFr: "Cotisation annuelle carte cr\xE9dit", unit: "fcfa", isDimensional: true, description: null },
  ...
  { code: "cartes.cotisation_prepaid", parentCode: "cartes", category: "cartes", displayLabelFr: "Cotisation carte pr\xE9pay\xE9e", unit: "fcfa", isDimensional: true, description: null },
  { code: "cartes.cotisation_virtuelle", parentCode: "cartes", category: "cartes", displayLabelFr: "Cotisation carte virtuelle", unit: "fcfa", isDimensional: false, description: "Carte e-commerce d\xE9mat\xE9rialis\xE9e" },
  { code: "cartes.retrait_dab_national", parentCode: "cartes", category: "cartes", displayLabelFr: "Retrait DAB national (m\xEAme banque)", unit: "fcfa", isDimensional: false, description: null },
  ...
  { code: "cartes.paiement_etranger", parentCode: "cartes", category: "cartes", displayLabelFr: "Paiement \xE0 l'\xE9tranger", unit: "percent", isDimensional: false, description: "Commission change incluse" },
  { code: "cartes.frais_change_etranger", parentCode: "cartes", category: "cartes", displayLabelFr: "Frais de change carte", unit: "percent", isDimensional: true, description: "Sur op\xE9rations en devise hors XOF/XAF" },
  ...
  { code: "cartes.reedition_pin", parentCode: "cartes", category: "cartes", displayLabelFr: "R\xE9\xE9dition code PIN", unit: "fcfa", isDimensional: false, description: null },
  { code: "cartes.renouvellement_anticipe", parentCode: "cartes", category: "cartes", displayLabelFr: "Renouvellement anticip\xE9", unit: "fcfa", isDimensional: false, description: null },
  { code: "cartes.envoi_recommande", parentCode: "cartes", category: "cartes", displayLabelFr: "Envoi recommand\xE9 carte", unit: "fcfa", isDimensional: false, description: null },
  ...
  // ========================================================================
  { code: "virements", parentCode: null, category: "virements", displayLabelFr: "Virements", unit: "fcfa", isDimensional: false, description: "Cat\xE9gorie racine virements" },
  ...
  { code: "virements.commission_emission", parentCode: "virements", category: "virements", displayLabelFr: "Commission \xE9mission virement", unit: "percent", isDimensional: true, description: null },
  { code: "virements.commission_reception", parentCode: "virements", category: "virements", displayLabelFr: "Commission r\xE9ception virement", unit: "fcfa", isDimensional: false, description: null },
  ...
  { code: "virements.instantane", parentCode: "virements", category: "virements", displayLabelFr: "Virement instantan\xE9", unit: "fcfa", isDimensional: false, description: null },
  ...
  // ========================================================================
  { code: "cheques", parentCode: null, category: "cheques", displayLabelFr: "Ch\xE8ques", unit: "fcfa", isDimensional: false, description: "Cat\xE9gorie racine ch\xE8ques" },
  ...
  { code: "cheques.carnet_personnalise", parentCode: "cheques", category: "cheques", displayLabelFr: "Carnet personnalis\xE9", unit: "fcfa", isDimensional: false, description: null },
  { code: "cheques.cheque_guichet", parentCode: "cheques", category: "cheques", displayLabelFr: "Ch\xE8que de guichet", unit: "fcfa", isDimensional: false, description: null },
  { code: "cheques.cheque_voyage", parentCode: "cheques", category: "cheques", displayLabelFr: "Ch\xE8que de voyage", unit: "percent", isDimensional: false, description: null },
  { code: "cheques.remise_sur_place", parentCode: "cheques", category: "cheques", displayLabelFr: "Remise ch\xE8que sur place", unit: "fcfa", isDimensional: false, description: null },
  { code: "cheques.remise_hors_place", parentCode: "cheques", category: "cheques", displayLabelFr: "Remise ch\xE8que hors place", unit: "fcfa", isDimensional: false, description: null },
  { code: "cheques.certification", parentCode: "cheques", category: "cheques", displayLabelFr: "Certification de ch\xE8que", unit: "fcfa", isDimensional: false, description: null },
  { code: "cheques.opposition", parentCode: "cheques", category: "cheques", displayLabelFr: "Opposition sur ch\xE8que", unit: "fcfa", isDimensional: false, description: null },
  { code: "cheques.rejet_emis", parentCode: "cheques", category: "cheques", displayLabelFr: "Rejet ch\xE8que \xE9mis", unit: "fcfa", isDimensional: false, description: null },
  { code: "cheques.rejet_recu", parentCode: "cheques", category: "cheques", displayLabelFr: "Rejet ch\xE8que re\xE7u", unit: "fcfa", isDimensional: false, description: null },
  { code: "cheques.cheque_certifie", parentCode: "cheques", category: "cheques", displayLabelFr: "Ch\xE8que certifi\xE9", unit: "fcfa", isDimensional: false, description: null },
  { code: "cheques.envoi_recommande", parentCode: "cheques", category: "cheques", displayLabelFr: "Envoi ch\xE9quier recommand\xE9", unit: "fcfa", isDimensional: false, description: null },
  // ========================================================================
  // 6. CRÉDITS (17 rubriques)
  // ========================================================================
  { code: "credits", parentCode: null, category: "credits", displayLabelFr: "Cr\xE9dits", unit: "percent", isDimensional: false, description: "Cat\xE9gorie racine cr\xE9dits" },
  { code: "credits.frais_dossier_conso", parentCode: "credits", category: "credits", displayLabelFr: "Frais de dossier cr\xE9dit conso", unit: "fcfa", isDimensional: true, description: null },
  { code: "credits.frais_dossier_immo", parentCode: "credits", category: "credits", displayLabelFr: "Frais de dossier cr\xE9dit immo", unit: "fcfa", isDimensional: true, description: null },
  { code: "credits.frais_dossier_equipement", parentCode: "credits", category: "credits", displayLabelFr: "Frais de dossier cr\xE9dit \xE9quipement", unit: "fcfa", isDimensional: true, description: null },
  { code: "credits.taux_conso", parentCode: "credits", category: "credits", displayLabelFr: "Taux cr\xE9dit consommation", unit: "percent", isDimensional: true, description: "Dimensions: montant, dur\xE9e, garantie" },
  { code: "credits.taux_immo", parentCode: "credits", category: "credits", displayLabelFr: "Taux cr\xE9dit immobilier", unit: "percent", isDimensional: true, description: null },
  { code: "credits.taux_equipement", parentCode: "credits", category: "credits", displayLabelFr: "Taux cr\xE9dit \xE9quipement", unit: "percent", isDimensional: true, description: null },
  { code: "credits.taux_revolving", parentCode: "credits", category: "credits", displayLabelFr: "Taux cr\xE9dit revolving", unit: "percent", isDimensional: false, description: null },
  { code: "credits.ira", parentCode: "credits", category: "credits", displayLabelFr: "Indemnit\xE9 de remboursement anticip\xE9", unit: "percent", isDimensional: false, description: null },
  { code: "credits.mainlevee", parentCode: "credits", category: "credits", displayLabelFr: "Mainlev\xE9e hypoth\xE8que", unit: "fcfa", isDimensional: false, description: null },
  { code: "credits.taux_usure", parentCode: "credits", category: "credits", displayLabelFr: "Taux d'usure applicable", unit: "percent", isDimensional: true, description: "Plafond L1 r\xE9glementaire" },
  { code: "credits.frais_avenant", parentCode: "credits", category: "credits", displayLabelFr: "Frais avenant cr\xE9dit", unit: "fcfa", isDimensional: false, description: "Modification dur\xE9e/montant" },
  { code: "credits.frais_renegociation", parentCode: "credits", category: "credits", displayLabelFr: "Frais ren\xE9gociation", unit: "percent", isDimensional: false, description: null },
  { code: "credits.frais_releve_credit", parentCode: "credits", category: "credits", displayLabelFr: "Relev\xE9 compte cr\xE9dit", unit: "fcfa", isDimensional: false, description: null },
  { code: "credits.cout_assurance", parentCode: "credits", category: "credits", displayLabelFr: "Co\xFBt assurance emprunteur", unit: "percent", isDimensional: true, description: null },
  { code: "credits.frais_relance", parentCode: "credits", category: "credits", displayLabelFr: "Frais relance impay\xE9", unit: "fcfa", isDimensional: false, description: null },
  ...
  // ========================================================================
  { code: "ebanking", parentCode: null, category: "ebanking", displayLabelFr: "Services \xE9lectroniques", unit: "fcfa", isDimensional: false, description: "Cat\xE9gorie racine e-banking" },
  ...
  { code: "ebanking.sms_alerte", parentCode: "ebanking", category: "ebanking", displayLabelFr: "SMS alerte (par op\xE9ration)", unit: "fcfa", isDimensional: false, description: null },
  ...
  { code: "ebanking.token_securite", parentCode: "ebanking", category: "ebanking", displayLabelFr: "Token de s\xE9curit\xE9", unit: "fcfa", isDimensional: false, description: null },
  ...
  { code: "ebanking.consultation_compte", parentCode: "ebanking", category: "ebanking", displayLabelFr: "Consultation compte (au-del\xE0 forfait)", unit: "fcfa", isDimensional: false, description: null },
  { code: "ebanking.opposition_acces", parentCode: "ebanking", category: "ebanking", displayLabelFr: "Opposition acc\xE8s e-banking", unit: "fcfa", isDimensional: false, description: null },
  { code: "ebanking.recuperation_acces", parentCode: "ebanking", category: "ebanking", displayLabelFr: "R\xE9cup\xE9ration acc\xE8s / d\xE9blocage", unit: "fcfa", isDimensional: false, description: null },
  { code: "ebanking.changement_password", parentCode: "ebanking", category: "ebanking", displayLabelFr: "Changement mot de passe assist\xE9", unit: "fcfa", isDimensional: false, description: null },
  // ========================================================================
  // 8. OPÉRATIONS SPÉCIALES (15 rubriques)
  // ========================================================================
  { code: "operations_speciales", parentCode: null, category: "operations_speciales", displayLabelFr: "Op\xE9rations sp\xE9ciales", unit: "fcfa", isDimensional: false, description: "Cat\xE9gorie racine op\xE9rations sp\xE9ciales" },
  ...
  { code: "operations_speciales.credit_documentaire", parentCode: "operations_speciales", category: "operations_speciales", displayLabelFr: "Cr\xE9dit documentaire", unit: "percent", isDimensional: true, description: null },
  ...
  { code: "operations_speciales.caution_marche", parentCode: "operations_speciales", category: "operations_speciales", displayLabelFr: "Caution de march\xE9", unit: "percent", isDimensional: true, description: null },
  { code: "operations_speciales.versement_especes", parentCode: "operations_speciales", category: "operations_speciales", displayLabelFr: "Versement esp\xE8ces", unit: "percent", isDimensional: true, description: null },
  { code: "operations_speciales.retrait_especes", parentCode: "operations_speciales", category: "operations_speciales", displayLabelFr: "Retrait esp\xE8ces guichet", unit: "percent", isDimensional: true, description: null },
  ...
  // ========================================================================
  { code: "incidents", parentCode: null, category: "incidents", displayLabelFr: "Incidents & divers", unit: "fcfa", isDimensional: false, description: "Cat\xE9gorie racine incidents" },
  { code: "incidents.cheque_rejete", parentCode: "incidents", category: "incidents", displayLabelFr: "Ch\xE8que rejet\xE9 (p\xE9nalit\xE9)", unit: "fcfa", isDimensional: false, description: null },
  ...
  { code: "incidents.retard_remboursement", parentCode: "incidents", category: "incidents", displayLabelFr: "Retard de remboursement", unit: "percent", isDimensional: false, description: "P\xE9nalit\xE9 en % du retard" },
  ...
  { code: "incidents.declaration_ficoba", parentCode: "incidents", category: "incidents", displayLabelFr: "D\xE9claration FICOBA", unit: "fcfa", isDimensional: false, description: null },
  { code: "incidents.recherche_operation", parentCode: "incidents", category: "incidents", displayLabelFr: "Recherche op\xE9ration ant\xE9rieure", unit: "fcfa", isDimensional: false, description: "Par op\xE9ration recherch\xE9e" },
  ...
  { code: "incidents.contestation_operation", parentCode: "incidents", category: "incidents", displayLabelFr: "Contestation d'op\xE9ration", unit: "fcfa", isDimensional: false, description: null },
  ...
  { code: "incidents.notification_evenement", parentCode: "incidents", category: "incidents", displayLabelFr: "Notification \xE9v\xE9nement compte", unit: "fcfa", isDimensional: false, description: null },
  { code: "incidents.frais_huissier", parentCode: "incidents", category: "incidents", displayLabelFr: "Frais huissier (refactur\xE9)", unit: "fcfa", isDimensional: false, description: null },
  { code: "incidents.frais_avocat", parentCode: "incidents", category: "incidents", displayLabelFr: "Frais avocat r\xE9gularisation", unit: "fcfa", isDimensional: false, description: null },
  // ========================================================================
  // DATES DE VALEUR (12 rubriques) — référence réglementaire BCEAO
  // ========================================================================
  { code: "dv", parentCode: null, category: "compte", displayLabelFr: "Dates de valeur", unit: "days", isDimensional: false, description: "Cat\xE9gorie dates de valeur" },
  { code: "dv.versement_especes", parentCode: "dv", category: "compte", displayLabelFr: "DV versement esp\xE8ces", unit: "days", isDimensional: false, description: "Max J+1 (BCEAO)" },
  { code: "dv.retrait_especes", parentCode: "dv", category: "compte", displayLabelFr: "DV retrait esp\xE8ces", unit: "days", isDimensional: false, description: "Min J (BCEAO)" },
  { code: "dv.cheque_sur_place", parentCode: "dv", category: "compte", displayLabelFr: "DV ch\xE8que sur place", unit: "days", isDimensional: false, description: "Max J+3 ouvr\xE9 (BCEAO)" },
  { code: "dv.cheque_hors_place", parentCode: "dv", category: "compte", displayLabelFr: "DV ch\xE8que hors place", unit: "days", isDimensional: false, description: "Variable selon zone" },
  { code: "dv.cheque_voyage", parentCode: "dv", category: "compte", displayLabelFr: "DV ch\xE8que de voyage", unit: "days", isDimensional: false, description: null },
  { code: "dv.virement_recu", parentCode: "dv", category: "compte", displayLabelFr: "DV virement re\xE7u", unit: "days", isDimensional: false, description: "Min J (BCEAO)" },
  { code: "dv.virement_emis", parentCode: "dv", category: "compte", displayLabelFr: "DV virement \xE9mis", unit: "days", isDimensional: false, description: null },
  ...
  { code: "dv.versement_especes_etranger", parentCode: "dv", category: "compte", displayLabelFr: "DV versement esp\xE8ces \xE9tranger", unit: "days", isDimensional: false, description: null }
];
var RUBRIC_INDEX = new Map(RUBRICS_TAXONOMY.map((r) => [r.code, r]));
function rubricUnitOf(code) {
  var _a;
  return ((_a = RUBRIC_INDEX.get(code)) == null ? void 0 : _a.unit) ?? "fcfa";
}

// src/billing/express/l2ToBankConditions.ts
function profilOf(dimensions) {
  if (dimensions && typeof dimensions === "object" && "profil" in dimensions) {
    const p = dimensions.profil;
    return typeof p === "string" ? p : void 0;
  }
  return void 0;
}
function l2ToBankConditions(params) {
  const { segment } = params;
  const valueByCode = /* @__PURE__ */ new Map();
  for (const c of params.conditions) {
    if (c.value_numeric == null) continue;
    const profil = profilOf(c.dimensions);
    if (segment && profil && profil !== segment) continue;
  ...
  const fees = [];
  const interestRates = [];
  const num = (code) => valueByCode.get(code) ?? 0;
  ...
  const tenueValue = valueByCode.has("compte.tenue_mensuelle") ? num("compte.tenue_mensuelle") : Math.round(num("compte.tenue_annuelle") / 12);
  const seg = segment ?? "particulier";
  const accountFees = {
    tenueCompte: {
  ...
  return {
    ...
    effectiveDate: params.effectiveFrom ? new Date(params.effectiveFrom) : /* @__PURE__ */ new Date(),
    fees,
    interestRates,
    isActive: true,
    accountFees
