...
function Pricing({ onCta, onExpress }: { onCta: () => void; onExpress: () => void }) {
  const plans = [
    ...
    },
    {
      ...
      features: [
        'Tout de l\'offre Entreprise, et :',
        'Clients illimités · comptes illimités',
        'Jusqu\'à 200 000 transactions / mois',
        '18 détecteurs statistiques + IA Claude/Ollama',
        'Rapports SYSCOHADA premium prêts à signer',
        'MFA + Allowlist IP · Audit trail SHA-256 immuable',
        'Multi-utilisateurs illimités',
        'Branding cabinet complet (logo, couleurs)',
        'Module facturation OHADA intégré',
        'Account Manager dédié · Support prioritaire 4h',
      ],
      cta: 'Démarrer 14 jours gratuit',
      highlighted: true,
      target: 'app' as const,
